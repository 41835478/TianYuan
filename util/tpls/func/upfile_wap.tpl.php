...
<head>
	...
	<style type="text/css">
	/* CSS Document */
	body{margin:0;padding:0;font:12px Arial,Times New Roman,"\5B8B\4F53",san-serif;width:60px;height:60px;overflow:hidden;}
	...
	#select-area label{display:inline-block;width:100%;height:40px;overflow:hidden;line-height:20px;padding:10px 0;text-align:center;background-color:#ddd;color:#fff;}
	#path {border:1px solid #cacaca;width:174px;height:28px;line-height:28px;position:relative;z-index:-1}
	input{float:left;}
	#filter{width:100%;height:30px;background:url('/static/img/func/file_loading.gif') no-repeat center -30px #ddd;position:absolute;top:15px;left:0;display:none;z-index:99}
	</style>
