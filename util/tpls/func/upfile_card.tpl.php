...
<head>
	...
	#select-area{width:60px;height:60px;overflow:hidden;position:relative;z-index:1;background:#fff url('/static/img/arbn-icons.png') no-repeat 14px 14px;background-size:160px auto;vertical-align:top;}
	#select-area label{display:inline-block;width:60px;height:40px;overflow:hidden;line-height:20px;padding:10px 0;text-align:center;}
	#path {border:1px solid #cacaca;width:174px;height:28px;line-height:28px;position:relative;z-index:-1;vertical-align:top;}
	input{float:left;}
