		...
		<table class="site-table">
			...
			<tbody>
				<tr>
					...
					<td style="text-align: center;"><input type="text" name="linkurl" id="linkurl" class="layui-input"></td>
					...
					<td style="text-align: center;"><a onclick="add_o()" class="layui-btn">添加新链接</a></td>
				</tr>
				<tr>
				</tr>
<?php $n=1;foreach($list as $k=>$v) {?>
				<tr>
					...
					<td style="text-align: center;"><input type="text" name="linkurl" id="link_<?=$v['id']?>" value="<?=$v['linkurl']?>" class="layui-input"></td>
