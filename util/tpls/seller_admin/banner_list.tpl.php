...
<div id="main" class="cont">
	...
	<div id="right_index">
		<div class="r_tit">店铺首页幻灯片管理<a href="/home/banner.html?c=add" class="fr layui-btn layui-btn-small">添加幻灯片</a> </div>
...
<?php $n=1;foreach($list as $k=>$v) {?>
				<tr>
					...
					<td style="text-align: center;"><img src="<?=$v['thumb']?>" width="200px"/></td>
					...
					<td style="text-align: center;"><a href="/home/banner.html?c=edit&id=<?=$v['id']?>" class="layui-btn layui-btn-small">修改</a> <a onclick="dele(<?=$v['id']?>)" class="layui-btn layui-btn-danger layui-btn-small">删除</a></td>
				</tr>
<?php $n++;}?>
			</tbody>
		</table>
