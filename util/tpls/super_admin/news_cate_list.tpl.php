...
<div class="am-cf admin-main">
	...
	<div class="admin-content">
		<div class="admin-content-body">
			<a href="/?m=admin&a=news" class="am-btn am-btn-secondary"><i class="fa fa-chevron-left"></i> 返回新闻列表</a>
			<div class="am-cf am-padding am-padding-bottom-0">
				<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新闻分类</strong> / <small>News Cate</small></div>
			</div>
			<hr>
			<div class="am-g">
				  ...
				  <form class="am-form">
					<table class="am-table am-table-striped am-table-hover table-main">
						...
						<tbody>
							<tr>
								<td></td>
								<td><input type="text" name="title" id="title" class="title" placeholder="请填写分类名称"></td>
								<td>
