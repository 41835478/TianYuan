...
<div id="main" class="cont">
	...
	<div id="right">
		<div class="r_tit"><a href="/home/mark.html">收藏的商品</a> <a href="/home/mark.html?org=shop" class="sel">收藏的店铺</a></div>
		<div class="goods_list">
			<div class="list_tit">
				<p>
					<span style="width:300px">店铺详情</span>
					<span style="width:110px">收藏人数</span>
					<span style="width:120px">宝贝数量</span>
...
?>
			<div class="li_good">
				<div class="s1 fl">
					...
					<div class="imgzon"><img src="<?=$shop['logo']?>" width="50px"/></div>
					<div class="goods-des">
						<p><?=$shop['title']?></p>
					</div>
				</div>
				<div class="s3 fl">
					<p>已有 <cite><?=$fav_count?></cite> 人<br/>收藏该店铺</p>
				</div>
				<div class="s4 fl">
					<p>共有 <cite><?=$nums?></cite> <br/>件商品</p>
				</div>
				<div class="s5 fl">
