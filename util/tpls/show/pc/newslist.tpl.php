...
.nch-article-list li a:hover{color:#009237}
...
<?php foreach($allcate as $k=>$v) {?>
					<li>
						<dl>
							<a href="/newslist_<?=$v['id']?>.html"><dt class="nch_art_tit <?php if($id==$v['id']){echo 'sel';}?>"><?=$v['title']?><i class="icon"></i></dt></a>
						</dl>
					</li>
<?php }?>
				</ul>
...
<script type="text/javascript">
    ...
    <div class="right">
    	<div class="nch-article-con">
        	<div class="title-bar">
				<h3><?=$allcate[$id]['title']?></h3>
			</div>
            <ul class="nch-article-list">
<?php $n=1;foreach($list as $s=>$q) {?>
            	<li>
                	<i><?=$n?>、</i>
                    <a href="/news_<?=$q['id']?>.html" title="<?=$q['title']?> "><?=$q['title']?></a>
                    <div class="time"><?=date('Y-m-d',$q['addtime'])?></div>
                </li>
<?php $n++;}?>
            </ul>
        </div>
