    ...
    a.fn.zclip = function (c) {
        if (typeof c == "object" && !c.length) {
            ...
            return this.each(function () {
                var e = a(this);
                if (e.is(":visible") && (typeof b.copy.val() == "string" || a.isFunction(b.copy.val()))) {
                    ZeroClipboard.setMoviePath(b.path);
                    var d = new ZeroClipboard.Client();
                    if (a.isFunction(b.copy.val())) {
                        e.bind("zClip_copy", b.copy.val())
                    }
                    ...
                    d.addEventListener("complete", function (f, g) {
                        if (a.isFunction(b.afterCopy)) {
                            ...
                            e.removeClass("hover");
                            alert("复制成功,您可以通过Ctrl+v粘贴到您想分享的地方！:\n\n " + g)
                        }
                        if (b.clickAfter) {
                            e.trigger("click")
                        }
