...
INSERT INTO `ucenter` VALUES('121','admin','e10adc3949ba59abbe56e057f20f883e','1483175569','122.4.202.147','1','0');
INSERT INTO `ucenter` VALUES('122','商铺测试','e10adc3949ba59abbe56e057f20f883e','1482886033','192.168.10.240','2','0');
INSERT INTO `ucenter` VALUES('123','个人会员','e10adc3949ba59abbe56e057f20f883e','1483082179','122.4.202.147','0','0');
--
-- 表的结构web_ad_pos
--
...
CREATE TABLE `web_backup_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='数据备份记录';
...
CREATE TABLE `web_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='商品订单表';
...
INSERT INTO `web_order` VALUES('6','123','MO161230165158237','1','147.40','75.00','13.40','5.00','3','1483087918','1483087918','','0');
INSERT INTO `web_order` VALUES('7','123','MO161230165449227','1','194.00','95.00','0.00','5.00','3','1483088089','1483088089','','0');
INSERT INTO `web_order` VALUES('8','123','MO161230165846145','1','194.00','95.00','0.00','0.00','0','1483088326','1483088326','','0');
INSERT INTO `web_order` VALUES('9','123','MO161230171133674','1','189.00','95.00','0.00','5.00','3','1483089093','1483089093','','0');
INSERT INTO `web_order` VALUES('10','123','MO161230171224190','1','126.00','65.00','0.00','5.00','3','1483089144','1483089144','','0');
--
...
CREATE TABLE `web_shop_goods_cart` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='用户购物车产品';
...
INSERT INTO `web_shop_goods_cart` VALUES('14','0','123','5','11.00','6','1483089186','0','0','0','');
--
...
CREATE TABLE `web_user_quan` (
  ...
  `time` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='用户的优惠券信息表';

--
-- 转存表中的数据 web_user_quan
--

INSERT INTO `web_user_quan` VALUES('5','0','3','0','1483175479');
INSERT INTO `web_user_quan` VALUES('2','123','3','0','1482720323');
INSERT INTO `web_user_quan` VALUES('3','121','1','0','1483082049');
